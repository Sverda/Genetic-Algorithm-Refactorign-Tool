...
namespace GenSharp.Refactorings.Analyzers.Metrics
{
    internal sealed class ComputationalComplexityMetrics
    {
        ...
        private static int GetExecutableLinesOfCode(IOperation operation, ref bool hasSymbolInitializer)
        {
        ...
        private static bool HasAnyExplicitExpression(IOperation operation)
        {
